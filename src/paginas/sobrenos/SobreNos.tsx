    ...
    <>
      <Grid container>
            ...
            <Grid container xs={12} sm={12} direction="row" justifyContent="center" >
                <Box width='18%' padding={5} className='marginText'>
                ...
                <Box width='18%' padding={5} className='marginText'>
                    ...
                    <Typography className='fontMerri'>Compartilhe suas ideias e opiniões sobre nossos temas</Typography>
                </Box>
            ...
            <Grid item xs={12} sm={12}>
                <Typography className='fontMerri marginText integrantColor padding' variant='h5' align='center'>Integrantes </Typography>
            </Grid>

            <Grid container className='integrantColor'>
                <Grid container direction="row" justifyContent="space-around" alignItems="center">
                    <Box width='25%' className='padding'>
                        ...
                        <Typography  align="center">Nome Completo</Typography>
                        <Typography  align="center">Uma breve descrição deste membro</Typography>
                    </Box> 
                    <Box width='25%' className='padding'>
                        <img className='perfis' src="https://i.pinimg.com/originals/54/bf/7a/54bf7a45856c608fe7165a908d57c7cf.png" alt="Foto de um integrante" />
                        <Typography  align="center">Nome Completo</Typography>
